...
$route['api/v1/docs']['get'] = 'api/v1/docs_api_v1/index';
$route['api/v1/docs/spec']['get'] = 'api/v1/docs_api_v1/spec';
$route['api/v1/docs/spec.json']['get'] = 'api/v1/docs_api_v1/spec';
$route['api/v1/docs/spec.yaml']['get'] = 'api/v1/docs_api_v1/spec_yaml';

// JWT Authentication Routes
$route['api/v1/auth/login']['post'] = 'api/v1/auth_api_v1/login';
$route['api/v1/auth/refresh']['post'] = 'api/v1/auth_api_v1/refresh';
$route['api/v1/auth/logout']['post'] = 'api/v1/auth_api_v1/logout';
$route['api/v1/auth/me']['get'] = 'api/v1/auth_api_v1/me';
$route['api/v1/auth/change-password']['post'] = 'api/v1/auth_api_v1/change_password';

// Two-Factor Authentication API Routes
$route['api/v1/2fa/verify']['post'] = 'api/v1/two_factor_api_v1/verify';
