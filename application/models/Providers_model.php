        ...
        if (array_key_exists('settings', $provider)) {
            $encoded_resource['settings'] = [
                ...
                'syncPastDays' => array_key_exists('sync_past_days', $provider['settings'])
                    ...
                    : null,
                'workingPlan' => array_key_exists('working_plan', $provider['settings']) && $provider['settings']['working_plan'] !== null
                    ? json_decode($provider['settings']['working_plan'], true)
                    : null,
                'workingPlanExceptions' => array_key_exists('working_plan_exceptions', $provider['settings']) && $provider['settings']['working_plan_exceptions'] !== null
