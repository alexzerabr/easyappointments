...
<div id="whatsapp-integration-page" class="container backend-page">
    <div class="row">
        ...
        <div id="whatsapp-integration" class="col-sm-8">
            ...
            <!-- Status alert removed: session status is not displayed on UI -->
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="whatsapp-host" data-field="host" class="form-control" 
                                       value="<?= $whatsapp_settings['host'] ?? 'http://localhost' ?>" 
                                       placeholder="http://localhost" required>
                                <div class="form-text"><?= lang('whatsapp_host_hint') ?></div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="whatsapp-port" class="form-label">
                                    <?= lang('whatsapp_port') ?> *
                                </label>
                                <input type="number" id="whatsapp-port" data-field="port" class="form-control" 
                                       value="<?= $whatsapp_settings['port'] ?? 21465 ?>" 
                                       min="1" max="65535" required>
                                <div class="form-text"><?= lang('whatsapp_port_hint') ?></div>
                            </div>
                        </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <!-- Session status row removed: UI should not display statuses -->
