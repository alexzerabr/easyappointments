...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="Easy!Appointments">
    <meta name="application-name" content="Easy!Appointments">
    <meta name="msapplication-TileColor" content="#35A768">
    ...
    <link rel="apple-touch-icon" href="<?= asset_url('assets/img/pwa/icon-192x192.png') ?>">
...
<!-- PWA Registration -->
<script src="<?= asset_url('assets/js/pwa-register.js') ?>"></script>
