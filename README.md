...
# Parar ambiente
./deploy/deploy-production.sh down
...
### Guias Principais
- 🚀 **[DEPLOY.md](DEPLOY.md)** - Deploy completo (Produção + Desenvolvimento)
- 🔨 **[BUILD.md](BUILD.md)** - Build de imagens e assets
- 🤝 **[CONTRIBUTING.md](CONTRIBUTING.md)** - Como contribuir

### Documentação Técnica
- 📖 **[docs/](docs/)** - Documentação técnica completa
- 🐳 **[docs/docker.md](docs/docker.md)** - Arquitetura Docker
- 🔌 **[docs/rest-api.md](docs/rest-api.md)** - API REST
- 📱 **[docs/whatsapp_token_runbook.md](docs/whatsapp_token_runbook.md)** - WhatsApp Integration
